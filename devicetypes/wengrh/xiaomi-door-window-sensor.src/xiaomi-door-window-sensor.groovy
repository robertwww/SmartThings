 ...
 */
metadata {
	definition (name: "Xiaomi Door/Window Sensor", namespace: "wengrh", author: "wengrh") {
		capability "Battery"
		...
		fingerprint profileId: "0104", deviceId: "0104", inClusters: "0000,0003,FFFF,0019", outClusters: "0000,0004,0003,0006,0008,0005,0019", manufacturer: "LUMI", model: "lumi.sensor_magnet", deviceJoinName: "Xiaomi Door/Windows Sensor"
	}
	...
	tiles(scale: 2) {
		...
		standardTile("icon", "device.lastOpened", inactiveLabel: false, decoration: "flat", width: 4, height: 1) {
...
def parse(String description) {
	...
	// TODO: handle 'lastOpened' attribute
...
def enrollResponse() {
	log.debug "Executing 'enrollResponse'"
	// TODO: handle 'enrollResponse' command
...
def resetClosed() {
	log.debug "Executing 'resetClosed'"
	// TODO: handle 'resetClosed' command
	sendEvent(name:"contact", value:"closed")
}

def resetOpen() {
	log.debug "Executing 'resetOpen'"
	// TODO: handle 'resetOpen' command
